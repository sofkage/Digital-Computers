...
main:
	...
	while_loop:
		...
		caseW:
			...
			addi $t0, $0, -1
			mul $s5, $s1, $t0  #kanoyme pollaplasiasmo gia na apokthsoyme to $s1 = - $s1 (w=-w) kai to vazoyme sto step
...
usleep:
	#tha einai to orisma to a0 opoy tha pernei sthn arxi ta deyterolepta kathisterhshs
	move $t1, $a0
	addi $t2, $0, 0  # i
